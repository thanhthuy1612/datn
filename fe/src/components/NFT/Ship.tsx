  ...
  const renderProfileNFT = () => (
    <div className="rounded-[20px] flex flex-col justify-between pb-[60px]">
      ...
      <div className="flex mt-[50px]">
        <button disabled={loadingCreate} className="border-boder border-[1px] rounded-[10px] py-[15px] px-[30px] hover:bg-hover shadow-md hover:shadow-xl" onClick={onFinish}>Nhận đơn</button>
      </div>
    </div>
  );
  const renderBody = () => (
