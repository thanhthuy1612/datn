...
contract NFTMarketplace is ERC721URIStorage {
  ...
  function createToken(
    ...
    createMarketItem(newTokenId, name, price, date); // tạo item
    return newTokenId;
  }

  function createMarketItem(uint256 tokenId,string memory name, uint256 price, uint256 date) private {
    // đẩy item lên sản
  ...
  function resellToken(uint256 tokenId, string memory name, uint256 price, uint256 date) public payable {
    // bán lại sau khi mua
    require(
